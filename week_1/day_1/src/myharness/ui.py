...
COMMANDS: tuple[tuple[str, str, str, bool], ...] = (
    ...
    ("/model", "[имя]", "список моделей или переключение модели", True),
    ("/profile", "[имя]", "профили генерации: список, переключение, сохранение", True),
    ("/params", "", "текущие параметры генерации", True),
