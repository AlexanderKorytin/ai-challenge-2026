...
способом, каким кликаются вкладки. Как и там, клик работает, пока мышь у harness, а она у него
по умолчанию; `F2` и `/mouse` отдают её терминалу целиком, и тогда клик по строке ничего не
выбирает.
"""
