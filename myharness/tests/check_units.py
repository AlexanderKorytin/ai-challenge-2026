...
check(
    "предложение с двоеточием разделом не становится, и отказ назван по существу",
    разборы["я хочу записать вот что: строку"][0] is None
    and "длиннее" in разборы["я хочу записать вот что: строку"][1],
