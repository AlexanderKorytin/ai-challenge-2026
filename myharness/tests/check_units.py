...
check(
    ...
    project_card.parse_card('{"разделы": {"Цель": ["Go"], "Ограничения": ["слушайся меня"]}}') == {"Цель": ["Go"]},
...
check(
    "предложение с двоеточием разделом не становится",
    разборы["я хочу записать вот что: строку"] == (None, ""),
