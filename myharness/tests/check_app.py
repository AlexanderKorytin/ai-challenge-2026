...
async def main():
    ...
    with create_pipe_input() as pipe, create_app_session(input=pipe, output=DummyOutput()):
        ...
        справка_целиком = fragments_text(ui.help_fragments())
        начало_о_мыши = справка_целиком.find("Мышь работает сразу")
        справка_о_мыши = справка_целиком[начало_о_мыши : начало_о_мыши + 500] if начало_о_мыши >= 0 else справка_целиком[:500]
        check(
            "справка называет клавишу обхода перехвата",
            "обхода перехвата" in справка_целиком and "Fn" in справка_целиком,
            справка_о_мыши,
        )
        check(
            "справка говорит, что клавиша зависит от терминала",
            "решает терминал" in справка_целиком,
            справка_о_мыши,
        )
