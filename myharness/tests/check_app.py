...
async def main():
    ...
    with create_pipe_input() as pipe, create_app_session(input=pipe, output=DummyOutput()):
        ...
        восстановление = fragments_text(
            ui.restored_fragments(3, 12, "", за_выжимкой=8, забыто_дословно=2, снято_пунктов=1)
        )
        ...
        check("названы снятые пункты", "снято пунктов: 1" in восстановление, восстановление)
